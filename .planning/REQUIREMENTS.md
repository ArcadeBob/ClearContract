...
- [ ] **CAREG-01**: Lien Rights pass receives CA mechanics lien law knowledge (prelim notice, recording deadlines, foreclosure, anti-waiver)
- [ ] **CAREG-02**: Labor Compliance pass receives prevailing wage/DIR knowledge (public works detection, CPR, apprenticeship threshold, penalties)
...
- [ ] **CAREG-04**: Relevant passes receive Title 24 climate-zone glazing requirements for energy code awareness
- [ ] **CAREG-05**: Labor Compliance pass receives Cal/OSHA safety requirements for glazing (fall protection, glass handling)
