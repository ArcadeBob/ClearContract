...
- [x] **FIND-04**: User can toggle "Hide resolved" to filter resolved findings from view
- [x] **FIND-05**: User sees resolved finding counts in the risk summary
...
- Satisfied: 13
- Pending (gap closure): 3 (ROUTE-01, ROUTE-02, EXPORT-02)
- Unmapped: 0
