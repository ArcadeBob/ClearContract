...
describe('Sidebar', () => {
  it('renders all navigation items', () => {
    render(
      <Sidebar activeView="dashboard" onNavigate={vi.fn()} contractCount={3} />
    );
  ...
  it('renders company branding', () => {
    render(
      <Sidebar activeView="dashboard" onNavigate={vi.fn()} contractCount={0} />
    );
  ...
  it('highlights active view -- contracts', () => {
    render(
      <Sidebar activeView="contracts" onNavigate={vi.fn()} contractCount={2} />
    );
  ...
  it('highlights active view -- settings', () => {
    render(
      <Sidebar activeView="settings" onNavigate={vi.fn()} contractCount={0} />
    );
  ...
  it('navigates to dashboard on click', async () => {
    ...
    render(
      <Sidebar activeView="contracts" onNavigate={onNavigate} contractCount={0} />
    );
  ...
  it('navigates to upload on click', async () => {
    const onNavigate = vi.fn();
    render(
      <Sidebar activeView="dashboard" onNavigate={onNavigate} contractCount={0} />
    );
    const user = userEvent.setup();
  ...
  it('shows contract count badge when count > 0', () => {
    render(
      <Sidebar activeView="dashboard" onNavigate={vi.fn()} contractCount={5} />
    );
